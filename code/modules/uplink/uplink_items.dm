...
/datum/uplink_item/explosives/syndicate_bomb/emp
	name = "Nanotrasen EMP Bomb"
	desc = "A variation of the NT bomb designed to produce a large EMP effect."
	item = /obj/item/sbeacondrop/emp
	cost = 7

/datum/uplink_item/explosives/syndicate_detonator
	name = "Nanotrasen Detonator"
	desc = "The Nanotrasen detonator is a companion device to the NT bomb. Simply press the included button \
