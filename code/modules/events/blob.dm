...
/datum/round_event/ghost_role/blob/announce(fake)
	priority_announce("Warning. Warning. Nanotrasen Biohazard has been injected onboard [station_name()]. All personnel must contain the outbreak.", "Biohazard Alert", ANNOUNCER_OUTBREAK5)
