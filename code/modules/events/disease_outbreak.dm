...
/datum/round_event/disease_outbreak/announce(fake)
	priority_announce("Warning. Warning. Nanotrasen Viral Biohazard has been injected onboard [station_name()]. All personnel must contain the outbreak.", "Biohazard Alert", 'sound/ai/default/outbreak7.ogg')
